...
from .my_sims import get_sims as gs_, assign_sims as as_,  update_sim_state as uss_
from .details import order_details as od_, sim_details as sd_, update_label as usl_, send_sms as ss_, user_details as ud_, update_user_account as uua_, update_user as uu_

...
get_sims = {
    ...
    'sim_status_filter': 'Filtro de estado SIM',
    'sub_status_filter': 'Suscripción',
    'filter_all': 'Todos',
    'filter_activated': 'Activada',
    'filter_deactivated': 'Desactivada',
    'filter_sub_active': 'Activa',
...
user_details = {
    ...
    'details': {
        ...
        'password_hidden': 'Solo el administrador puede restablecerla.',
        'total': 'Total de SIMs:',
    },
    'alerts': {

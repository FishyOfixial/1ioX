...
MERCADOPAGO_AUTH_URL = (os.environ.get("MERCADOPAGO_AUTH_URL") or "https://auth.mercadopago.com/authorization").strip()
MERCADOPAGO_CLIENT_ID = (os.environ.get("MERCADOPAGO_CLIENT_ID") or "").strip()
MERCADOPAGO_CLIENT_SECRET = (os.environ.get("MERCADOPAGO_CLIENT_SECRET") or "").strip()
MERCADOPAGO_REDIRECT_URI = (os.environ.get("MERCADOPAGO_REDIRECT_URI") or "").strip()
